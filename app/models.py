...
class BusinessRegistration(db.Model):
    ...
    def __init__(self, businessname, business_street_address, business_city, business_country, contactnumber, email, firstname, lastname, nominalcapital,business_category):
